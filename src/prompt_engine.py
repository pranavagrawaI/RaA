...
def generate_caption(image_path: str, prompt: str) -> str:
    ...
    print(f"Generating caption for {image_path} with prompt: {prompt}")
...
def generate_image(prompt: str, text: str) -> Image.Image:
    ...
    return _generate_image_with_gemini(prompt, text)


def _generate_image_with_gemini(prompt: str, text: str) -> Image.Image:
    """Return an image generated by Gemini given a prompt and text."""
